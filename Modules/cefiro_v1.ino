...
// definicion de dimensiones de la pantalla oled
...
//-------------------------------------SD----------------------------------------------------------
// Definiciones de pines para el módulo microSD
...
void MQ135(){
  ...
  sensorValue = analogRead(MQ135_PIN); // Lee el valor del sensor desde el pin GPIO34
  voltage = sensorValue * (3.3 / 4095.0); // Convierte el valor leído a voltaje
...
void cargarDatos() {
  ...
  if (myFile) {
    ...
    Serial.print(",Temperatura_MHZ (C): ");                  
    Serial.print(temperature); 
